...
while True:
    ...
    if success:
        ...
        if pose:
            ...
            bar = np.interp(angle, (70, 170), (w//2-100, w//2+100))
            ...
            if dir == 0 and angle >= 70 and angle <= 170:
                img = cv2AddChineseText(img, string3, (coordinate[0],coordinate[1] - 75), (255, 255, 255), 30)
                cv2.rectangle(img, (coordinate[0] - 25, coordinate[1] - 100), (coordinate[0] + 225, coordinate[1] - 25), (0, 0, 0), 2)
            if dir == 1 and angle >= 70 and angle <= 170:
